...
En nuestras historias de usuarios vamos a describir los detalles de la funcionalidad que se desean realizar en nuestro proyecto, además de la prioridad y el estimado.
...
\begin{table}[htbp]
	\begin{center}
		\begin{tabular}{|p{10cm} | p{2cm} | p{2cm}|}
			...
			Detalle & Prioridad & Estimado \\
			\hline
			Como usuario, yo debería ser capaz de registrarme con Gmail y Facebook de la la aplicación web o móvil y consumir los datos desde una API. Además de mostralo en interfases agradables al usuario y entendible & 20 & 4h \\
			\hline	
		\end{tabular}
	\end{center}
\end{table}
